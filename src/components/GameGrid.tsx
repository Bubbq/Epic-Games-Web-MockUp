...
function GameGrid() {
  ...
  return (
    <>
      ...
      <SimpleGrid columns={{sm: 1, md: 2, lg: 3, xl: 5}} padding ='10px' spacing={10}>{/*obj in columns makes it where depending on screen size, x amount of cards will render */}
        {games.map( //this callback function maps out every element of the games array obj to the screen
          (singleGame) => (
